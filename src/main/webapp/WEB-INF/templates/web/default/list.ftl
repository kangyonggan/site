...
<div class="space-20"></div>
    <#assign respCode=articlesDto.respCode/>

    <#if respCode=='F'>
    <div class="space-30"></div>
    <div class="text-center">
    ${articlesDto.respMsg!'未知异, 请稍后重试, 如果还是不行， 那就联系康永敢'}
    </div>
    <#elseif respCode=='E'>
    <div class="space-30"></div>
    <div class="text-center">
    ...
    <#else>
        <#if articlesDto.page?? && articlesDto.page.list?? && articlesDto.page.list?size gt 0>
            <#assign page=articlesDto.page/>
